...
export default function CTASection({
  ...
  return (
    <section className="bg-paper-warm px-5 py-20 sm:px-6 lg:py-28">
      <div
        data-reveal
        className="relative mx-auto max-w-6xl overflow-hidden rounded-[32px] bg-ink px-6 py-16 text-center sm:px-10 lg:py-20"
      >
        <div
          aria-hidden="true"
        ...
        <div className="relative">
          <h2 className="mx-auto max-w-2xl font-serif text-3xl leading-[1.08] tracking-tight text-paper sm:text-4xl lg:text-5xl">
            {title}
          </h2>
