...
export default function CTA() {
  return (
    <section id="contacto" className="bg-paper-warm px-5 py-20 sm:px-6 lg:py-28">
      <div
        data-reveal
        className="relative mx-auto max-w-6xl overflow-hidden rounded-[32px] bg-ink px-6 py-16 text-center sm:px-10 lg:py-24"
      >
        ...
        <div className="relative">
          ...
          <h2 className="mx-auto max-w-2xl font-serif text-4xl leading-[1.05] tracking-tight text-paper sm:text-5xl lg:text-6xl">
            Deja que tu equipo dirija la obra.
            <br />
            <span className="italic text-white/70">Deja que mnnsor lleve los datos.</span>
          </h2>
