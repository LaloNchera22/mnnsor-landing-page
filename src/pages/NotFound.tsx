  ...
  return (
    <section className="flex min-h-[70vh] items-center justify-center px-5 pt-32 pb-20 text-center">
      <div>
        ...
        <Link
          to="/"
          className="group mt-9 inline-flex items-center gap-2 rounded-full bg-ink px-6 py-3.5 text-base font-medium text-paper transition-transform duration-300 hover:-translate-y-0.5"
        >
          Volver al inicio
